...
export default function StrategySettingsPage() {
  ...
  const mtfMode = String(mtfContract?.activation_mode ?? "DRAFT");
  const mtfOperational = mtfContract?.operational_effect === true;
  const mtfDecisions = mtfAudit?.runtime.decisions_24h;

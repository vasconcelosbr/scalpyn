...
export default function PumpRadarPage() {
  ...
  const runInProgress = run ? ["QUEUED", "RUNNING", "CANCELLING"].includes(run.status) : false;
  const runProgressLabel = run ? `${run.processed_assets}/${run.total_assets} ativos processados` : "";

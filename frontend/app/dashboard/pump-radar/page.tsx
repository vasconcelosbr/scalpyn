...
type RadarConfig = { minimum_rise_pct: number; maximum_window_minutes: number; retracement_pct: number; no_new_high_minutes: number; maximum_duration_minutes: number; merge_gap_minutes: number; backfill_days: number; volume_filter_enabled: boolean; liquidity_filter_enabled: boolean; atr_filter_enabled: boolean; [key: string]: unknown };

...
class CanonicalAnalysisDataset(BaseModel):
    ...
    tenant_id: UUID
    contract_version: str = "canonical-analysis-dataset-v1"
...
class CanonicalDatasetService:
    DOMAIN_TABLES = {
        ...
        "MARKET_REGIME": ("market_regime_history",),
    }
    ...
    def build(self, *, tenant_id: UUID, request: CanonicalDatasetRequest,
              ...
              feature_contract_version: str | None = None,
              label_contract_version: str | None = None) -> CanonicalAnalysisDataset:
        ...
        if conflicts:
            ...
            quality_status = "PASS"
        dataset_payload = {
            "tenant_id": str(tenant_id), "contract_version": "canonical-analysis-dataset-v1",
        ...
        return CanonicalAnalysisDataset(
            tenant_id=tenant_id, source_tables=self.DOMAIN_TABLES[request.domain],

...
_DEFAULT_SOURCE_BY_INDICATOR: Dict[str, DataSource] = {
    ...
    "ema5_distance_pct": DataSource.GATE_CANDLES,
    "ema21_distance_pct": DataSource.GATE_CANDLES,
    "ema50_distance_pct": DataSource.GATE_CANDLES,
    "ema200_distance_pct": DataSource.GATE_CANDLES,
    ...
    "bb_upper_distance_pct": DataSource.GATE_CANDLES,
    "bb_middle_distance_pct": DataSource.GATE_CANDLES,
    "bb_lower_distance_pct": DataSource.GATE_CANDLES,
    "recent_high_5m_distance_pct": DataSource.GATE_CANDLES,
    "recent_high_15m_distance_pct": DataSource.GATE_CANDLES,
    "recent_high_30m_distance_pct": DataSource.GATE_CANDLES,
    "recent_high_1h_distance_pct": DataSource.GATE_CANDLES,
    "recent_low_15m_distance_pct": DataSource.GATE_CANDLES,
    "price_change_1m_pct": DataSource.GATE_CANDLES,
    "price_change_5m_pct": DataSource.GATE_CANDLES,
    "price_change_15m_pct": DataSource.GATE_CANDLES,

"""Repair the Analysis Chat prompt after a typed-UUID insert failure.

Revision ID: 159_chat_prompt_repair
Revises: 158_chat_provider_prompt
"""
...
revision = "159_chat_prompt_repair"
down_revision = "158_chat_provider_prompt"
branch_labels = None
depends_on = None

PROMPT_ID = uuid.UUID("2c1fec5d-59bb-502f-8b3b-724b9c790689")
...
def _content() -> dict:
    return {
        ...
        "output_schema_json": {
            "type": "object",
            "required": [
                "answer", "answer_type", "based_on",
                "parent_analysis_run_id", "evidence_refs",
            ],
            "properties": {
                "answer": {"type": "string"},
                "answer_type": {
